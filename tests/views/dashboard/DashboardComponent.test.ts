...
describe('Dashboard Component', () => {
        ...
        mockPlugin = {
            ...
            cache: {
                suggestions: [
                    ...
                    { id: 'cycle_1', type: 'deterministic', category: 'error', link: 'C', source: 'D', timestamp: 0 },
                    { id: 'ai_1', type: 'ai', category: 'suggestion', link: 'E', source: 'F', timestamp: 0 },
                ],
                history: [],
            },
            executor: {
    ...
    it('filters items when clicking tabs', async () => {
        ...
        const logicTab = Array.from(target.querySelectorAll('.healer-tab-btn')).find(
    ...
    it('shows empty state when no items match tab', async () => {
        ...
        const blackHoleTab = Array.from(target.querySelectorAll('.healer-tab-btn')).find(
