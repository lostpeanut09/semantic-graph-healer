...
class TestAdapter extends BaseAdapter {
    ...
    public _isPluginAvailable(id: string): boolean {
        return (this as unknown as { isPluginAvailable: (pluginId: string) => boolean }).isPluginAvailable(id);
    }

    public _logDebug(msg: string): void {
        return (this as unknown as { logDebug: (message: string) => void }).logDebug(msg);
    }

    public _ensureInitialized(): void {
        return (this as unknown as { ensureInitialized: () => void }).ensureInitialized();
    }
}
