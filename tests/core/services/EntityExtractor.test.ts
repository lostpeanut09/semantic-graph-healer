...
describe('EntityExtractor', () => {
    ...
    it('should extract entities and relationships and save them to storage', async () => {
        ...
        (mockLlmService.callLlm as ReturnType<typeof vi.fn>).mockResolvedValue(mockResponse);
    ...
    it('should handle malformed JSON responses gracefully', async () => {
        const mockFile = { path: 'test.md', basename: 'test' } as TFile;
        (mockLlmService.callLlm as ReturnType<typeof vi.fn>).mockResolvedValue('Not a JSON response');
