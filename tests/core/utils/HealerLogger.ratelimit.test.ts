...
describe('HealerLogger Rate Limit', () => {
    ...
    it('test_perModuleCap_doesNotBlockOtherModules', () => {
        ...
        const bufA = (loggerA as unknown as { logBuffer: Array<unknown> }).logBuffer;
        const bufB = (loggerB as unknown as { logBuffer: Array<unknown> }).logBuffer;
    ...
    it('test_setDedupConfig_updatesLive', () => {
        ...
        expect((logger as unknown as { logBuffer: Array<unknown> }).logBuffer.length).toBe(5);
