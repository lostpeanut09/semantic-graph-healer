...
export function renderSecurityApiKeysSettings(containerEl: HTMLElement, ctx: SectionContext) {
    const { plugin } = ctx;
            ...
            button
                ...
                .onClick(async () => {
                    if (keychainStatus) {
                        ...
                        await plugin.keychainService.migrateFromSettingsToKeychain('openai');
