...
export function renderPhase3InferenceSettings(
  ...
  new Setting(containerEl)
    ...
    .setDesc(
      'Force reciprocity even for weak "related" links using AI validation.',
    )
    .addToggle((toggle) =>
      toggle
        .setValue(plugin.settings.requireRelatedReciprocity)
        .onChange((value) => {
  ...
  new Setting(containerEl)
    ...
    .setDesc(
      "Permit a note to have multiple sequential continuations without topological errors.",
    )
    .addToggle((toggle) =>
  ...
  new Setting(containerEl)
    ...
    .setDesc(
      "Permit a note to have multiple sequential predecessors without topological errors.",
    )
    .addToggle((toggle) =>
  ...
  new Setting(containerEl)
    ...
    .setDesc(
      "On-demand verification for next and previous branches. Independent from the automated tribunal.",
    )
    .addToggle((toggle) =>
      toggle
        .setValue(plugin.settings.requireAIBranchValidation)
        .onChange((value) => {
  ...
  new Setting(containerEl)
    ...
    .addToggle((toggle) =>
      toggle
        .setValue(plugin.settings.requireAITagValidation)
        .onChange((value) => {
