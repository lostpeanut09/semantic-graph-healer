...
export function renderSettingsProfilesSettings(containerEl: HTMLElement, ctx: SectionContext) {
        ...
        .addDropdown((dropdown) => {
            dropdown
                ...
                .onChange(async (value: string) => {
                    ...
                    if (confirmed) {
                        const presets: Record<SettingsPreset, Partial<typeof plugin.settings>> = {
                            balanced: {
