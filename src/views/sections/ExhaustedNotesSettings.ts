...
export function renderExhaustedNotesSettings(containerEl: HTMLElement, ctx: SectionContext) {
    ...
    new Setting(containerEl)
        ...
        .setDesc(`Number of notes marked as fully scanned: ${plugin.settings.fullyScannedNotes.length}`)
        .addButton((btn) =>
