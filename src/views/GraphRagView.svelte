...
<div class="healer-graphrag-container" style="padding: 1em; display: flex; flex-direction: column; gap: 1em;">
  ...
  {#if !loading && !answer && communities.length === 0}
    <div class="healer-empty-state" style="border: 2px dashed var(--background-modifier-border); border-radius: 8px; padding: 3em 1em; text-align: center; color: var(--text-muted); margin-top: 1em;">
