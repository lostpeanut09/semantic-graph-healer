...
<div class="healer-graphrag-container" style="padding: 1em; display: flex; flex-direction: column; gap: 1em;">
  ...
  {#if !loading && !answer && communities.length === 0}
    <div class="healer-empty-state healer-card" style="padding: 2em; text-align: center; border-style: dashed; border-color: var(--background-modifier-border); margin-top: 2em;">
      <span aria-hidden="true" style="font-size: 2em; opacity: 0.5;">🧠</span>
      <h3 style="margin-top: 0.5em; color: var(--text-normal);">Explore your Vault's Topology</h3>
      <p style="color: var(--text-muted); font-size: 0.9em; max-width: 400px; margin: 0.5em auto 0;">
        Ask questions about themes, clusters, or bridging concepts across your entire knowledge graph.
      </p>
    </div>
  {/if}
