...
<div class="healer-graphrag-container" style="padding: 1em; display: flex; flex-direction: column; gap: 1em;">
  ...
  {#if !loading && !answer && communities.length === 0}
    <div class="healer-card healer-empty-state" style="border-style: dashed; padding: 2em; text-align: center; color: var(--text-muted); border-radius: 8px; margin-top: 1em; border-width: 1px; border-color: var(--background-modifier-border);">
      <div style="font-size: 2em; margin-bottom: 0.5em;" aria-hidden="true">💡</div>
      <p style="margin: 0; font-size: 1.1em; font-weight: 500;">GraphRAG</p>
      <p style="margin-top: 0.5em; font-size: 0.9em;">Ask a question to synthesize insights from your vault's semantic clusters.</p>
    </div>
  {/if}
