...
<div class="healer-graphrag-container" style="padding: 1em; display: flex; flex-direction: column; gap: 1em;">
  ...
  {:else if !answer && communities.length === 0}
    <div class="healer-card healer-empty-state" style="border-style: dashed; padding: 2em; text-align: center; color: var(--text-muted); margin-top: 1em;">
      <div aria-hidden="true" style="font-size: 2em; margin-bottom: 0.5em; opacity: 0.5;">🔍</div>
      <p style="margin: 0;">Ask a question to explore connections across your knowledge graph.</p>
    </div>
  {/if}
