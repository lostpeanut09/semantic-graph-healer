...
<div class="healer-graphrag-container" style="padding: 1em; display: flex; flex-direction: column; gap: 1em;">
  ...
  {#if !loading && !answer && communities.length === 0}
    <div class="healer-empty-state" style="padding: 3em 1em; text-align: center; border: 2px dashed var(--background-modifier-border); border-radius: 8px; color: var(--text-muted); margin-top: 1em;">
      <span aria-hidden="true" style="font-size: 2em; display: block; margin-bottom: 0.5em;">🔍</span>
      <p style="margin: 0; font-size: 1.1em; color: var(--text-normal);">Ready to explore your graph.</p>
      <p style="margin: 0.5em 0 0; font-size: 0.9em;">Ask a question above to synthesize insights from your vault.</p>
    </div>
  {/if}
