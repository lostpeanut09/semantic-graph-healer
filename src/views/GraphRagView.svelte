...
<div class="healer-graphrag-container" style="padding: 1em; display: flex; flex-direction: column; gap: 1em;">
  ...
  {:else if !answer && communities.length === 0}
    <div class="healer-card healer-empty-state" style="border-style: dashed; padding: 3em 1em; text-align: center; color: var(--text-muted);">
      ...
      <p style="margin-top: 0.5em; font-size: 0.9em; opacity: 0.8;">Ask a question above to start analyzing knowledge graph clusters.</p>
    </div>
  {/if}
