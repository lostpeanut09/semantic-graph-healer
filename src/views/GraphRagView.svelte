...
<div class="healer-graphrag-container" style="padding: 1em; display: flex; flex-direction: column; gap: 1em;">
  ...
  {#if !loading && !answer}
    <div class="healer-empty-state" style="padding: 2em; text-align: center; color: var(--text-muted); border: 2px dashed var(--background-modifier-border); border-radius: 8px;">
      <span aria-hidden="true" style="font-size: 2em; display: block; margin-bottom: 0.5em;">🔍</span>
      <p>Ask a question to explore connections across your knowledge graph.</p>
    </div>
  {/if}
