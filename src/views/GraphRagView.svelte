...
<div class="healer-graphrag-container" style="padding: 1em; display: flex; flex-direction: column; gap: 1em;">
  ...
  {:else if !answer && communities.length === 0}
    <div class="healer-card healer-empty-state" style="padding: 2em; text-align: center; color: var(--text-muted); border-style: dashed; border-width: 2px; border-radius: 8px;">
      <div style="font-size: 2em; margin-bottom: 0.5em;" aria-hidden="true">🧠</div>
      <p>Ask a question to explore your knowledge graph.</p>
    </div>
  {/if}
