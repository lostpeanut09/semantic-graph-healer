...
> This plugin is still being developed and is not available in the official Obsidian plugins marketplace yet. It is still fully experimental; however, releases that start with the name `endpoint` are probably experimental and mostly unstable, used only for testing.
